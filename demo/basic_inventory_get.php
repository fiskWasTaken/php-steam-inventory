...
print("{$response->getCurrentPage()->getItemCount()} items in inventory.\n");

print("First item is: {$response->getCurrentPage()->getItem(0)->getDescription()['name']}\n");
print("Fifth item is: {$response->getCurrentPage()->getItem(4)->getDescription()['name']}\n");